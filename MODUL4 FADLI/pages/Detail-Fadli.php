        ...
        <div class="isian d-flex justify-content-center mt-5">
            ...
            <div class="col">
                <div class="row">
                    <form action="" class=" w-75" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="foto" name="foto" accept="image/*"
                                placeholder="<?= $list["foto_mobil"]?>" value="<?= $list["foto_mobil"]?>" readonly>
                            <span><?php echo $list["foto_mobil"] ?></span>
                        </div>
                        <div class="mb-3">
                    ...
                    <a href="Edit-Fadli.php?id=<?= $list["id_mobil"]; ?>"><button
